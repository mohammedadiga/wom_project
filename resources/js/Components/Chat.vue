                      ...
                      <ul class="right_chat list-unstyled mb-0 animation-li-delay">
                          <li class="online">
                              <a href="javascript:void(0);" class="media">
                                  <img class="media-object" :src="'/storage/images/sm/avatar4.jpg'" alt="">
                          ...
                          <li class="online">
                              <a href="javascript:void(0);" class="media">
                                  <img class="media-object " :src="'/storage/images/sm/avatar5.jpg'" alt="">
                                  <div class="media-body">
                          ...
                          <li class="offline">
                              <a href="javascript:void(0);" class="media">
                                  <img class="media-object " :src="'/storage/images/sm/avatar2.jpg'" alt="">
                                  <div class="media-body">
                          ...
                          <li class="offline">
                              <a href="javascript:void(0);" class="media">
                                  <img class="media-object " :src="'/storage/images/sm/avatar1.jpg'" alt="">
                                  <div class="media-body">
                          ...
                          <li class="online">
                              <a href="javascript:void(0);" class="media">
                                  <img class="media-object " :src="'/storage/images/sm/avatar3.jpg'" alt="">
                                  <div class="media-body">
